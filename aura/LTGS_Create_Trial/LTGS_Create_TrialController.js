...
doInit : function(component, event, helper) {
        ...
        var recordName='LCRM_CreateTrial_TW';
        ...
        action.setParams({"recordName":recordName});
                   ...
                   //console.log('222 '+recordName);
                    action1.setParams({"recordId":recordId});
                            ...
                            var opportunityID18= Oppty.OpportunityID18__c;
                             url=url.replace('<oppid>', opportunityID18);
                            var productCount= Oppty.LCRM_Product_Count__c; 
                           //console.log('555 '+opportunityID18);
                             $A.get("e.force:closeQuickAction").fire();
                                if(productCount==0)
                                {
                                   var errorMsg='Opportunity product count should be atleast 1';
                                    ...
                                    toastEvent.fire();
                                        ...
                                        alert('Opportunity product count should be atleast 1');
                                    } 
                                }
                              else{
                ...
                alert('Trial Wizard records not present in Custom Setting. Please contact your System Admin');
            		}
    		});
