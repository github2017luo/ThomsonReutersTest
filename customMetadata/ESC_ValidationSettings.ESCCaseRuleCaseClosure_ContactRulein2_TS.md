...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>ESCCaseRuleCaseClosure_ContactRulein2_TS</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Elite CPQ User,TR Sales - Lightning,TR Service Partner User,Elite Sales Ops,Elite User,UKI Sales Ops,TR Legal US Sales User, TR Helpdesk Agent, TR Helpdesk Manager, TR Accountable Resolver, TR Hybrid Agent,TR Sales Ops - Lightning,TR Read Only - Lightning</value>
    </values>
    <values>
