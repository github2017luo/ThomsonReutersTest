...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>printproviewandcdromcancellationreq7</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Submitting a modification request is not a guarantee of cancellation. All requests are reviewed according to contract terms.We will contact you to confirm your request before any cancellations can be completed.</value>
    </values>
    <values>
        <field>ESC_Field_Type__c</field>
        <value xsi:type="xsd:string">OutputText</value>
    </values>
    <values>
        <field>ESC_Form_Name__c</field>
        <value xsi:type="xsd:string">print-proview-and-cd-rom-cancellation-request</value>
    </values>
    <values>
