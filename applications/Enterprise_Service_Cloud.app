...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>MissedMilestones</components>
    ...
    <label>Enterprise Service Cloud</label>
    <preferences>
    ...
    <tabs>GLI_DomainSelectorList__c</tabs>
    ...
    <tabs>ESC_Case_Form_Extension__c</tabs>
    <tabs>Apttus_Config2__ProductConfiguration__c</tabs>
    <workspaceConfig>
        <mappings>
            <tab>Apttus_Config2__ProductConfiguration__c</tab>
        </mappings>
        <mappings>
            <tab>Core_Home</tab>
        </mappings>
        <mappings>
            <tab>ESC_Case_Collaborator__c</tab>
        </mappings>
        <mappings>
            <tab>ESC_Case_Form_Extension__c</tab>
        </mappings>
        <mappings>
            <tab>ESC_GlobalSearch</tab>
        </mappings>
        <mappings>
            <tab>GLI_DomainSelectorList__c</tab>
        </mappings>
        <mappings>
