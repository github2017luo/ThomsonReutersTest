...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Service console created to support CX Digital Chat functionality</description>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>CX Digital Console</label>
    <preferences>
    ...
    <workspaceConfig>
        <mappings>
            <tab>AdvancedSearch__c</tab>
        </mappings>
        <mappings>
            <tab>Global_Reports</tab>
        </mappings>
        <mappings>
            <tab>Payment_Reporting</tab>
        </mappings>
        <mappings>
            <tab>Source_System_Detail__c</tab>
        </mappings>
        <mappings>
