...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>APTS Cancel Backup on Expiration</fullName>
        <active>true</active>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Apttus_Approval__SetCancellationDatetoNOW</name>
                <type>FieldUpdate</type>
            </actions>
            <actions>
                <name>Apttus_Approval__SetEffectiveDatetoNull</name>
                <type>FieldUpdate</type>
            </actions>
            <actions>
                <name>Apttus_Approval__SetExpirationDatetoNull</name>
                <type>FieldUpdate</type>
            </actions>
            <actions>
                <name>Apttus_Approval__SetInEffectFlagtoFalse</name>
                <type>FieldUpdate</type>
            </actions>
            <actions>
                <name>Apttus_Approval__SetIsActivetoFalse</name>
                <type>FieldUpdate</type>
            </actions>
    ...
    <rules>
        <fullName>APTS Set In Effect on Effective Date</fullName>
        <active>true</active>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Apttus_Approval__SetCancellationDatetoNull</name>
                <type>FieldUpdate</type>
            </actions>
            <actions>
                <name>Apttus_Approval__SetEffectiveDatetoNull</name>
            ...
            <actions>
                <name>Apttus_Approval__SetInEffectFlagtoTrue</name>
                <type>FieldUpdate</type>
            </actions>
